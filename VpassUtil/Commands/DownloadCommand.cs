...
namespace VpassUtil.Cli.Commands
{
    public class DownloadCommand : AsyncCommand<DownloadSettings>
    {
        ...
        {
            settings.Cookie = AnsiConsole.Ask<string>("Cookieを入力してください、ブラウザのF12を押してネットワークタブから取得してください");
            settings.Start = AnsiConsole.Ask<string>("開始を表すyyyy-mmを入力してください");
            settings.End = AnsiConsole.Ask<string>("終了を表すyyyy-mmを入力してください");
