...
internal class VPassApiClient : IDisposable
{
    ...
    internal VPassApiClient(string cookie)
    {
        _cookie = cookie;
        _httpClient = new HttpClient();
    }
    internal async Task<string> FetchDetailCsvAsync(int year, int month)
    {
    ...
    internal HttpRequestMessage CreateHistoryRequest(int year, int month)
    {
